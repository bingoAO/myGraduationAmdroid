...
public class RefreshListView extends LinearLayout implements View.OnTouchListener {
    ...
    public RefreshListView(Context context, AttributeSet attrs) {
        ...
        header = LayoutInflater.from(context).inflate(R.layout.head_view, null, true);
        progressBar = (ProgressBar) header.findViewById(R.id.progress);
        arrow = (ImageView) header.findViewById(R.id.arrow);
        description = (TextView) header.findViewById(R.id.tips);
        updateAt = (TextView) header.findViewById(R.id.last_updated);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && !loadOnce) {
            measureView((LinearLayout) header);
